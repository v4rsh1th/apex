...
const Squeeze = () => {
  ...
  useEffect(() => {
    const runBlockCount = async () => {
      const ethersBlockNumber = await ethers.providers.getDefaultProvider("mainnet");
      ...
      <div className="flex md:flex-row flex-col items-start justify-between md:p-20 py-12">
        ...
        <div className="flex flex-col flex-1 items-center justify-start w-full md:mt-0 mt-10">
          ...
          <div className={styles.etherscan_block}>
            <p><a href="https://etherscan.io/" target={"_blank"} rel="noopener noreferrer" >Etherscan ↝</a></p>
          </div>
          <br />
